...
1. Copy the smart-library folder from the repository.
2. Paste the folder into the htdocs directory of your XAMPP installation (usually located at C:\xampp\htdocs).
3. Open XAMPP Control Panel and start both Apache and MySQL.
4. Open your web browser and go to: localhost/phpmyadmin/
5. Create a new database named:smart_library
6. Select the newly created database, click Import, and import the file: smart_library.sql
...
Make sure XAMPP services are running before accessing the system.